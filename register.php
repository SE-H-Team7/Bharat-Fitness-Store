   ...
   <div class="header">
	<div class="container">
		<div class="header-top">
      		 <div class="logo">
				<a href="index.php"><img src="" alt="Bharat Fitness Store"/></a>
			 </div>
    ...
    <div class="main">
	   <div class="container">
		  <div class="register">
		  	  <form id="form2" name="form2" method="POST" action="doregister.php" target="frame1">
				 <div class="register-top-grid">
					<h3>PERSONAL INFORMATION</h3>
					 ...
					 <div>
						 ...
						 <input onblur="checkemail(this.value)" name="uemail" type="email">
					 </div>

					 <div>
						 <span>Contact Number<label>*</label></span>
						 <input name="uphoneno"  type="text" >
					 </div>
					 <div>
						 <span>Address<label>*</label></span>
						 <input  name="uaddress" type="text">
					 </div>
					 </div>
				     <div class="register-bottom-grid">
						    <h3>LOGIN INFORMATION</h3>
							 ...
							 <div>
								...
								<input onkeyup="validatepwd(this.value)" type="text">
							 </div>
							 <div>
				...
				<div class="register-but">
					   ...
					   <input type="submit"  onclick="checkdetails(event)" value="submit" >
					   <div class="clearfix"> </div>
				   </form>
				</div>
		   </div>
        ...
        <div class="footer_bottom">
        	<div class="container">
        		<div class="copy">
				   <p>Copyright &copy; 2017 Bharat Fitness Store. All Rights Reserved . Design by Team7 </p>
			    </div>
        	</div>
        </div>
				...
				$("#frame1").attr("src","checkemail.php?email="+email);
				...
				if(str=="Available"){
					$("#emailavailable").html("Available<label>*</label>");
				emailavail=1;
				}
				else {
					$("#emailavailable").html("Not Available<label>*</label>");
				emailavail=0;
				}
				}
				function validatepwd(val) {
				if(val==$('input[name="upwd"]').val()){$("#samepwd").html("Correct Password<label>*</label>");samepwd=1;}
				else{$("#samepwd").html("Incorrect Password<label>*</label>");samepwd=0;}
				}


				function checkdetails(event){

				if (emailavail!=1 || samepwd!=1){event.preventDefault();window.alert("Provide correct details to proceed further!!");}
				...
				<iframe id="frame1" name="frame1" src="" width="0" height="0"></iframe>
